...
class ViscoseFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        dialog_search_history.setContentView(R.layout.dialog_search_history)
        val recycler2=dialog_search_history.findViewById<RecyclerView>(R.id.recycler_search_history)
        ...
        binding.searchHistoryViscose.setOnClickListener {
            ...
            ref3.addListenerForSingleValueEvent(object :ValueEventListener{
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    if(p0.exists()) {
                        dialog_search_history.findViewById<androidx.appcompat.widget.Toolbar>(R.id.search_his_toolbar).title="Search History"
                        ...
                        Snackbar.make(binding.coordinatorLayout, "NO HISTORY", Snackbar.LENGTH_SHORT).setTextColor(Color.WHITE).show()
                    }
                }
        ...
        binding.viewedHistoryViscose.setOnClickListener {
            ...
            ref3.addListenerForSingleValueEvent(object :ValueEventListener{
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    if(p0.exists()) {
                        dialog_search_history.findViewById<androidx.appcompat.widget.Toolbar>(R.id.search_his_toolbar).title="Viewed History"
                        viewed_list = mutableListOf()
                        for (datasnap in p0.children) {
                            val data = datasnap.getValue(ViewedHistoryData::class.java)
                            viewed_list.add(data!!)
